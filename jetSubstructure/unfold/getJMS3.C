...
void getJMS3(int kSample = kPbPb, int icent=0, int optX =1, int optY=2, bool doReweight=false) {
  TH1::SetDefaultSumw2();
  int nXbins;
  double xBin[30];
  ...
  */
  ...
  c2s->SaveAs(Form("jms/jes_kSample%d_icent%d-3.pdf",kSample,icent));
  ...
  leg1s->Draw();
  c3a->SaveAs(Form("jms/jer_kSample%d_icent%d-3.pdf",kSample,icent));
