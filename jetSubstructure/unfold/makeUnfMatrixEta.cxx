...
void makeUnfMatrixEta(int kSample = kPbPb, int optX =1, int optY=2,int etaBin =1 , bool doReweight=true, int nSys=-1) {
...
#ifndef __CINT__
int main () { makeUnfMatrixEta(); return 0; }  // Main program when run stand-alone
#endif
