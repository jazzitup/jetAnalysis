...
RooUnfoldResponse* getResponse(int kSample,  int icent,  int optX, int optY, TH2D* hTruth, TH2D* hReco, TH2D* respX, TH2D* respY, double radius, bool doReweight)
{
  ...
  if ( doReweight ) {
    ...
    //    hReweight = (TH2D*)fReweight->Get(Form("hRatioSmooth2_kSample%d_icent%d_opt2",kSample,icent));
    hReweight = (TH2D*)fReweight->Get(Form("hRatioSmooth2_kSample%d_icent%d_opt771",kSample,icent));
    //    hReweight = (TH2D*)fReweight->Get(Form("hRatioFit_kSample%d_icent%d_opt781",kSample,icent));
