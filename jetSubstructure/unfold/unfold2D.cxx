...
void unfold2D(int kSample = kPP, int optX =1, int optY=2, int etaBin=0, bool doReweight=false, int nSys=-1) {
  ...
  TString matrixName = Form("spectraFiles/unfoldingMatrix2D_coll%d_optX%d_optY%d_etaBin%d_doReweight%d.root",
			    kSample,optX,optY, etaBin, (int)matrixWeight);
  if ( nSys>= 0) {
    matrixName =       Form("spectraFiles/sys/unfoldingMatrix2D_coll%d_optX%d_optY%d_etaBin%d_doReweight%d_sys%d.root",
  ...
  TString foutName = Form("unfSpectra/kSample%d_etaBin%d_matrixRwt%d_spectraRwt%d_optX%d_optY%d.root",kSample,etaBin,matrixWeight,doReweight,optX,optY); 
  if ( nSys >=0 ) { 
    foutName = Form("unfSpectra/sys/kSample%d_etaBin%d_matrixRwt%d_spectraRwt%d_sys%d_optX%d_optY%d.root",kSample,etaBin,matrixWeight,doReweight,nSys,optX,optY);
  }
