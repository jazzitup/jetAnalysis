...
/*
  ...
  TH1D* hEffDrap[10];
*/
void drawSoftDrop_scan(TString name = "", float thetaCut =0., int numEvents =  1000000, int ptLow=150, int ptHigh=250) {

  TString fnamePP = "ntuples_jetSubstructure/substructure_output_pp_2.root";
  TString fnameAA = Form("ntuples_jetSubstructure/%s",name.Data());
  TString prefix = Form("%s_theta%.1f",name.Data(), thetaCut );
